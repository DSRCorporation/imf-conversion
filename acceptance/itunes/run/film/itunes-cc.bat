...
@echo on
%PROG% itunes -c ..\..\..\config.xml -m convert --imp %1 --cpl %2 -w %3 --vendor-id %4 --cc %5 -l debug -p film -d
@echo off
exit /b 0
...
:fifth-missing
@echo on
@echo Missing argument: a path to closed captions.
@echo off
goto :usage
...
@echo 5th argument - a path to closed captions.
