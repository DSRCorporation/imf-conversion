...
@echo on
%PROG% itunes -c ..\..\..\config.xml -m convert --imp %1 --cpl %2 -w %3 --vendor-id %4 -f %5 -l debug -p film -d
@echo off
exit /b 0
...
:fifth-missing
@echo on
@echo Missing argument: a iTunes video format.
@echo off
goto :usage
...
@echo 5th argument - a iTunes video format.
