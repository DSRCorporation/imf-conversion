...
@echo on
%PROG% itunes -c ..\..\..\config.xml -m convert --imp %1 --cpl %2 -w %3 --vendor-id %4 --sub %5 %6 %7 -l debug -p film -d
@echo off
exit /b 0
...
:fifth-missing
@echo on
@echo Missing argument: a path to subtitles.
@echo off
goto :usage
...
@echo 5-7th arguments - a paths to subtitles.
