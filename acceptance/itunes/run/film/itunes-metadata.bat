...
@echo on
%PROG% itunes -c ..\..\..\config.xml -m convert --imp %1 --cpl %2 -w %3 --vendor-id %4 --metadata %5 -l debug -p film -d
@echo off
exit /b 0
...
:fifth-missing
@echo on
@echo Missing argument: a metadata.xml.
@echo off
goto :usage
...
@echo 5th argument - a path to metadata.xml.
