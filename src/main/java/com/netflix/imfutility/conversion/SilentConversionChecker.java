...
import com.netflix.imfutility.xsd.config.AllowDisalow;
...
public class SilentConversionChecker {
    ...
    public SilentConversionChecker(TemplateParameterContextProvider contextProvider, FormatConfigurationType formatConfigurationType, ConfigProvider configProvider) {
    ...
    private boolean isAllow(AllowDisalow allowDisallow) {
        return (allowDisallow == null) || (allowDisallow == AllowDisalow.YES);
    }
