...
/**
 * Provides functionality to generate sample metadata.xml for iTunes film specification.
 */
public final class FilmMetadataXmlCreator {

    private FilmMetadataXmlCreator() {
    }
    ...
    public static void generateSampleXml(String path) {
        ...
        try {
            ...
            JAXBElement<PackageType> metadataJaxb = new ObjectFactory().createPackage(FilmMetadataXmlSampleBuilder.buildPackage());
