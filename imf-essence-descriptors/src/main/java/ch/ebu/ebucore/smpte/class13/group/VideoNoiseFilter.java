 ...
 *       &lt;all>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}videoNoiseFilterTypeGroupObject" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}videoNoiseFilterVendorId" minOccurs="0"/>
...
@XmlRootElement(name = "videoNoiseFilter")
public class VideoNoiseFilter {

    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected TypeGroupStrongReference videoNoiseFilterTypeGroupObject;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected UTF16String videoNoiseFilterVendorId;
    ...
    /**
     * Gets the value of the videoNoiseFilterTypeGroupObject property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public TypeGroupStrongReference getVideoNoiseFilterTypeGroupObject() {
        return videoNoiseFilterTypeGroupObject;
    }

    /**
     * Sets the value of the videoNoiseFilterTypeGroupObject property.
     * 
     * @param value
     *     allowed object is
     *     {@link TypeGroupStrongReference }
     *     
     */
    public void setVideoNoiseFilterTypeGroupObject(TypeGroupStrongReference value) {
        this.videoNoiseFilterTypeGroupObject = value;
    }

    /**
     * Gets the value of the videoNoiseFilterVendorId property.
     * 
     * @return
     *     possible object is
     *     {@link UTF16String }
     *     
     */
    public UTF16String getVideoNoiseFilterVendorId() {
        return videoNoiseFilterVendorId;
    }

    /**
     * Sets the value of the videoNoiseFilterVendorId property.
     * 
     * @param value
     *     allowed object is
     *     {@link UTF16String }
     *     
     */
    public void setVideoNoiseFilterVendorId(UTF16String value) {
        this.videoNoiseFilterVendorId = value;
    }
