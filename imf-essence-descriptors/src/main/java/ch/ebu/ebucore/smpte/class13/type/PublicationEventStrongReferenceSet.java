...
/**
 * <p>Java class for publicationEventStrongReferenceSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="publicationEventStrongReferenceSet">
 *   &lt;complexContent>
...
@XmlType(name = "publicationEventStrongReferenceSet", propOrder = {
    "publicationEvent"
})
public class PublicationEventStrongReferenceSet {

    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/group")
    protected List<PublicationEvent> publicationEvent;
    ...
    public List<PublicationEvent> getPublicationEvent() {
        if (publicationEvent == null) {
            publicationEvent = new ArrayList<PublicationEvent>();
        }
