...
/**
 * <p>Java class for alternativeTitleStrongReferenceSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="alternativeTitleStrongReferenceSet">
 *   &lt;complexContent>
...
@XmlType(name = "alternativeTitleStrongReferenceSet", propOrder = {
    "alternativeTitle"
})
public class AlternativeTitleStrongReferenceSet {

    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/group")
    protected List<AlternativeTitle> alternativeTitle;
     ...
     * 
     */
    public List<AlternativeTitle> getAlternativeTitle() {
        if (alternativeTitle == null) {
            alternativeTitle = new ArrayList<AlternativeTitle>();
        }
