...
/**
 * <p>Java class for audioChannelFormatStrongReferenceSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="audioChannelFormatStrongReferenceSet">
 *   &lt;complexContent>
...
@XmlType(name = "audioChannelFormatStrongReferenceSet", propOrder = {
    "audioChannelFormat"
})
public class AudioChannelFormatStrongReferenceSet {

    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/group")
    protected List<AudioChannelFormat> audioChannelFormat;
     ...
     * 
     */
    public List<AudioChannelFormat> getAudioChannelFormat() {
        if (audioChannelFormat == null) {
            audioChannelFormat = new ArrayList<AudioChannelFormat>();
        }
