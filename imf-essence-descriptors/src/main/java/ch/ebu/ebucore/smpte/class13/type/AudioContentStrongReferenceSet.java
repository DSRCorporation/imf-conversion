...
/**
 * <p>Java class for audioContentStrongReferenceSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="audioContentStrongReferenceSet">
 *   &lt;complexContent>
...
@XmlType(name = "audioContentStrongReferenceSet", propOrder = {
    "audioContent"
})
public class AudioContentStrongReferenceSet {

    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/group")
    protected List<AudioContent> audioContent;
     ...
     * 
     */
    public List<AudioContent> getAudioContent() {
        if (audioContent == null) {
            audioContent = new ArrayList<AudioContent>();
        }
