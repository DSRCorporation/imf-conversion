...
/**
 * <p>Java class for periodOfTimeStrongReferenceSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="periodOfTimeStrongReferenceSet">
 *   &lt;complexContent>
...
@XmlType(name = "periodOfTimeStrongReferenceSet", propOrder = {
    "periodOfTime"
})
public class PeriodOfTimeStrongReferenceSet {

    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/group")
    protected List<PeriodOfTime> periodOfTime;
     ...
     * 
     */
    public List<PeriodOfTime> getPeriodOfTime() {
        if (periodOfTime == null) {
            periodOfTime = new ArrayList<PeriodOfTime>();
        }
