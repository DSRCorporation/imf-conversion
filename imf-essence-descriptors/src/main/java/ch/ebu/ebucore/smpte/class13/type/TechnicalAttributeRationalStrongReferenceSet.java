...
/**
 * <p>Java class for technicalAttributeRationalStrongReferenceSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="technicalAttributeRationalStrongReferenceSet">
 *   &lt;complexContent>
...
@XmlType(name = "technicalAttributeRationalStrongReferenceSet", propOrder = {
    "technicalAttributeRational"
})
public class TechnicalAttributeRationalStrongReferenceSet {

    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/group")
    protected List<TechnicalAttributeRational> technicalAttributeRational;
     ...
     * 
     */
    public List<TechnicalAttributeRational> getTechnicalAttributeRational() {
        if (technicalAttributeRational == null) {
            technicalAttributeRational = new ArrayList<TechnicalAttributeRational>();
        }
