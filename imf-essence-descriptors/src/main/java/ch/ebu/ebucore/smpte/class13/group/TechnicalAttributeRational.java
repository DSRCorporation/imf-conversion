 ...
 *       &lt;all>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}technicalAttributeRationalTypeGroupObject" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}technicalAttributeRationalValueObject" minOccurs="0"/>
...
@XmlRootElement(name = "technicalAttributeRational")
public class TechnicalAttributeRational {

    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected TypeGroupStrongReference technicalAttributeRationalTypeGroupObject;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected RationalStrongReference technicalAttributeRationalValueObject;
    ...
    /**
     * Gets the value of the technicalAttributeRationalTypeGroupObject property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public TypeGroupStrongReference getTechnicalAttributeRationalTypeGroupObject() {
        return technicalAttributeRationalTypeGroupObject;
    }

    /**
     * Sets the value of the technicalAttributeRationalTypeGroupObject property.
     * 
     * @param value
     *     allowed object is
     *     {@link TypeGroupStrongReference }
     *     
     */
    public void setTechnicalAttributeRationalTypeGroupObject(TypeGroupStrongReference value) {
        this.technicalAttributeRationalTypeGroupObject = value;
    }

    /**
     * Gets the value of the technicalAttributeRationalValueObject property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public RationalStrongReference getTechnicalAttributeRationalValueObject() {
        return technicalAttributeRationalValueObject;
    }

    /**
     * Sets the value of the technicalAttributeRationalValueObject property.
     * 
     * @param value
     *     allowed object is
     *     {@link RationalStrongReference }
     *     
     */
    public void setTechnicalAttributeRationalValueObject(RationalStrongReference value) {
        this.technicalAttributeRationalValueObject = value;
    }
