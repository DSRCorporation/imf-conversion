...
/**
 * <p>Java class for IDRefStrongReferenceSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="IDRefStrongReferenceSet">
 *   &lt;complexContent>
...
@XmlType(name = "IDRefStrongReferenceSet", propOrder = {
    "idRef"
})
public class IDRefStrongReferenceSet {

    @XmlElement(name = "IDRef", namespace = "http://www.ebu.ch/ebucore/smpte/class13/group")
    protected List<IDRef> idRef;
     ...
     * 
     */
    public List<IDRef> getIDRef() {
        if (idRef == null) {
            idRef = new ArrayList<IDRef>();
        }
        return this.idRef;
    }
