 ...
 *       &lt;all>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}audioMXFLookupPackageUIDRefObject" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}audioMXFLookupChannelIDRefObject" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}audioMXFLookupTrackIDRefObject" minOccurs="0"/>
...
@XmlRootElement(name = "audioMXFLookup")
public class AudioMXFLookup {

    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected IDRefStrongReference audioMXFLookupPackageUIDRefObject;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected IDRefStrongReference audioMXFLookupChannelIDRefObject;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected IDRefStrongReference audioMXFLookupTrackIDRefObject;
    ...
    /**
     * Gets the value of the audioMXFLookupPackageUIDRefObject property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public IDRefStrongReference getAudioMXFLookupPackageUIDRefObject() {
        return audioMXFLookupPackageUIDRefObject;
    }

    /**
     * Sets the value of the audioMXFLookupPackageUIDRefObject property.
     * 
     * @param value
     *     allowed object is
     *     {@link IDRefStrongReference }
     *     
     */
    public void setAudioMXFLookupPackageUIDRefObject(IDRefStrongReference value) {
        this.audioMXFLookupPackageUIDRefObject = value;
    }

    /**
     * Gets the value of the audioMXFLookupChannelIDRefObject property.
     * 
     * @return
     *     possible object is
     *     {@link IDRefStrongReference }
     *     
     */
    public IDRefStrongReference getAudioMXFLookupChannelIDRefObject() {
        return audioMXFLookupChannelIDRefObject;
    }

    /**
     * Sets the value of the audioMXFLookupChannelIDRefObject property.
     * 
     * @param value
     *     allowed object is
     *     {@link IDRefStrongReference }
     *     
     */
    public void setAudioMXFLookupChannelIDRefObject(IDRefStrongReference value) {
        this.audioMXFLookupChannelIDRefObject = value;
    }

    /**
     * Gets the value of the audioMXFLookupTrackIDRefObject property.
     * 
     * @return
     *     possible object is
     *     {@link IDRefStrongReference }
     *     
     */
    public IDRefStrongReference getAudioMXFLookupTrackIDRefObject() {
        return audioMXFLookupTrackIDRefObject;
    }

    /**
     * Sets the value of the audioMXFLookupTrackIDRefObject property.
     * 
     * @param value
     *     allowed object is
     *     {@link IDRefStrongReference }
     *     
     */
    public void setAudioMXFLookupTrackIDRefObject(IDRefStrongReference value) {
        this.audioMXFLookupTrackIDRefObject = value;
    }
