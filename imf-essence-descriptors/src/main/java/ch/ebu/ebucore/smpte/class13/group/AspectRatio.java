 ...
 *       &lt;all>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}aspectRatioTypeGroupObject" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}aspectRatioDenominator" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}aspectRatioNumerator" minOccurs="0"/>
...
@XmlRootElement(name = "aspectRatio")
public class AspectRatio {

    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected TypeGroupStrongReference aspectRatioTypeGroupObject;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    @XmlSchemaType(name = "anySimpleType")
    protected String aspectRatioDenominator;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    @XmlSchemaType(name = "anySimpleType")
    protected String aspectRatioNumerator;
    ...
    /**
     * Gets the value of the aspectRatioTypeGroupObject property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public TypeGroupStrongReference getAspectRatioTypeGroupObject() {
        return aspectRatioTypeGroupObject;
    }

    /**
     * Sets the value of the aspectRatioTypeGroupObject property.
     * 
     * @param value
     *     allowed object is
     *     {@link TypeGroupStrongReference }
     *     
     */
    public void setAspectRatioTypeGroupObject(TypeGroupStrongReference value) {
        this.aspectRatioTypeGroupObject = value;
    }

    /**
     * Gets the value of the aspectRatioDenominator property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getAspectRatioDenominator() {
        return aspectRatioDenominator;
    }

    /**
     * Sets the value of the aspectRatioDenominator property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAspectRatioDenominator(String value) {
        this.aspectRatioDenominator = value;
    }

    /**
     * Gets the value of the aspectRatioNumerator property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getAspectRatioNumerator() {
        return aspectRatioNumerator;
    }

    /**
     * Sets the value of the aspectRatioNumerator property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAspectRatioNumerator(String value) {
        this.aspectRatioNumerator = value;
    }
