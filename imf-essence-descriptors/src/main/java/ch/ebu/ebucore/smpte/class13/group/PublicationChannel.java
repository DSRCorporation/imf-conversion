 ...
 *       &lt;all>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}publicationChannelTypeGroupObject" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}publicationChannelName" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}publicationChannelId" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}publicationChannelLinkToLogo" minOccurs="0"/>
...
@XmlRootElement(name = "publicationChannel")
public class PublicationChannel {

    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected TypeGroupStrongReference publicationChannelTypeGroupObject;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected UTF16String publicationChannelName;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected UTF16String publicationChannelId;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected UTF16String publicationChannelLinkToLogo;
    ...
    /**
     * Gets the value of the publicationChannelTypeGroupObject property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public TypeGroupStrongReference getPublicationChannelTypeGroupObject() {
        return publicationChannelTypeGroupObject;
    }

    /**
     * Sets the value of the publicationChannelTypeGroupObject property.
     * 
     * @param value
     *     allowed object is
     *     {@link TypeGroupStrongReference }
     *     
     */
    public void setPublicationChannelTypeGroupObject(TypeGroupStrongReference value) {
        this.publicationChannelTypeGroupObject = value;
    }

    /**
     * Gets the value of the publicationChannelName property.
     * 
     * @return
     *     possible object is
     *     {@link UTF16String }
     *     
     */
    public UTF16String getPublicationChannelName() {
        return publicationChannelName;
    }

    /**
     * Sets the value of the publicationChannelName property.
     * 
     * @param value
     *     allowed object is
     *     {@link UTF16String }
     *     
     */
    public void setPublicationChannelName(UTF16String value) {
        this.publicationChannelName = value;
    }
     ...
     *     
     */
    public UTF16String getPublicationChannelId() {
     ...
     *     
     */
    public void setPublicationChannelId(UTF16String value) {
        this.publicationChannelId = value;
    }

    /**
     * Gets the value of the publicationChannelLinkToLogo property.
     * 
     * @return
     *     possible object is
     *     {@link UTF16String }
     *     
     */
    public UTF16String getPublicationChannelLinkToLogo() {
        return publicationChannelLinkToLogo;
    }

    /**
     * Sets the value of the publicationChannelLinkToLogo property.
     * 
     * @param value
     *     allowed object is
     *     {@link UTF16String }
     *     
     */
    public void setPublicationChannelLinkToLogo(UTF16String value) {
        this.publicationChannelLinkToLogo = value;
    }
