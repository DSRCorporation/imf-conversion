 ...
 *       &lt;all>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}audioTrackAudioStreamFormatIDRefObjects" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}audioTrackFormatFormatGroupObject" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}audioTrackFormatName" minOccurs="0"/>
 *         &lt;element ref="{http://www.ebu.ch/ebucore/smpte/class13/element}audioTrackFormatId" minOccurs="0"/>
...
public class AudioTrackFormat {
    ...
    protected IDRefStrongReferenceSet audioTrackAudioStreamFormatIDRefObjects;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected FormatGroupStrongReference audioTrackFormatFormatGroupObject;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected UTF16String audioTrackFormatName;
    @XmlElement(namespace = "http://www.ebu.ch/ebucore/smpte/class13/element")
    protected UTF16String audioTrackFormatId;
    ...
    /**
     * Gets the value of the audioTrackAudioStreamFormatIDRefObjects property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public IDRefStrongReferenceSet getAudioTrackAudioStreamFormatIDRefObjects() {
        return audioTrackAudioStreamFormatIDRefObjects;
    }

    /**
     * Sets the value of the audioTrackAudioStreamFormatIDRefObjects property.
     * 
     * @param value
     *     allowed object is
     *     {@link IDRefStrongReferenceSet }
     *     
     */
    public void setAudioTrackAudioStreamFormatIDRefObjects(IDRefStrongReferenceSet value) {
        this.audioTrackAudioStreamFormatIDRefObjects = value;
    }

    /**
     * Gets the value of the audioTrackFormatFormatGroupObject property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public FormatGroupStrongReference getAudioTrackFormatFormatGroupObject() {
        return audioTrackFormatFormatGroupObject;
    }

    /**
     * Sets the value of the audioTrackFormatFormatGroupObject property.
     * 
     * @param value
     *     allowed object is
     *     {@link FormatGroupStrongReference }
     *     
     */
    public void setAudioTrackFormatFormatGroupObject(FormatGroupStrongReference value) {
        this.audioTrackFormatFormatGroupObject = value;
    }
     ...
     *     
     */
    public UTF16String getAudioTrackFormatName() {
     ...
     *     
     */
    public void setAudioTrackFormatName(UTF16String value) {
     ...
     *     
     */
    public UTF16String getAudioTrackFormatId() {
     ...
     *     
     */
    public void setAudioTrackFormatId(UTF16String value) {
