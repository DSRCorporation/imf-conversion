...
/**
 * <p>Java class for DataDefinitionStrongReferenceSet complex type.
 * 
...
@XmlType(name = "DataDefinitionStrongReferenceSet", propOrder = {
    "dataDefinition"
})
public class DataDefinitionStrongReferenceSet {

    @XmlElement(name = "DataDefinition", namespace = "http://www.smpte-ra.org/reg/395/2014/13/1/aaf")
    protected List<DataDefinition> dataDefinition;
     ...
     * This is why there is not a <CODE>set</CODE> method for the dataDefinition property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataDefinition().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<DataDefinition> getDataDefinition() {
        if (dataDefinition == null) {
            dataDefinition = new ArrayList<DataDefinition>();
        }
