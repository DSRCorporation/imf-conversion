 ...
 *       &lt;all>
 *         &lt;element ref="{http://www.smpte-ra.org/reg/335/2012}CryptographicContextID"/>
 *         &lt;element ref="{http://www.smpte-ra.org/reg/335/2012}SourceContainerFormat"/>
 *         &lt;element ref="{http://www.smpte-ra.org/reg/335/2012}CryptographicKeyID"/>
 *         &lt;element ref="{http://www.smpte-ra.org/reg/335/2012}MICAlgorithm"/>
 *         &lt;element ref="{http://www.smpte-ra.org/reg/335/2012}CipherAlgorithm"/>
...
@XmlRootElement(name = "CryptographicContext")
public class CryptographicContext {

    @XmlElement(name = "CryptographicContextID", namespace = "http://www.smpte-ra.org/reg/335/2012", required = true)
    @XmlSchemaType(name = "anyURI")
    protected String cryptographicContextID;
    @XmlElement(name = "SourceContainerFormat", namespace = "http://www.smpte-ra.org/reg/335/2012", required = true)
    @XmlSchemaType(name = "anyURI")
    protected String sourceContainerFormat;
    @XmlElement(name = "CryptographicKeyID", namespace = "http://www.smpte-ra.org/reg/335/2012", required = true)
    @XmlSchemaType(name = "anyURI")
    protected String cryptographicKeyID;
    @XmlElement(name = "MICAlgorithm", namespace = "http://www.smpte-ra.org/reg/335/2012", required = true)
    @XmlSchemaType(name = "anyURI")
    protected String micAlgorithm;
    @XmlElement(name = "CipherAlgorithm", namespace = "http://www.smpte-ra.org/reg/335/2012", required = true)
    @XmlSchemaType(name = "anyURI")
    ...
    /**
     * Gets the value of the cryptographicContextID property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getCryptographicContextID() {
        return cryptographicContextID;
    }

    /**
     * Sets the value of the cryptographicContextID property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setCryptographicContextID(String value) {
        this.cryptographicContextID = value;
    }

    /**
     * Gets the value of the sourceContainerFormat property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSourceContainerFormat() {
        return sourceContainerFormat;
    }

    /**
     * Sets the value of the sourceContainerFormat property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSourceContainerFormat(String value) {
        this.sourceContainerFormat = value;
    }
    ...
    /**
     * Gets the value of the micAlgorithm property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the micAlgorithm property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMICAlgorithm(String value) {
        this.micAlgorithm = value;
    }
