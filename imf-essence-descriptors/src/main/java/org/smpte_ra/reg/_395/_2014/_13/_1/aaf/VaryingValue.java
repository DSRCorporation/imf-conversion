 ...
 *       &lt;all>
 *         &lt;element ref="{http://www.smpte-ra.org/reg/335/2012}Interpolation"/>
 *         &lt;element ref="{http://www.smpte-ra.org/reg/335/2012}PointList"/>
 *         &lt;element ref="{http://www.smpte-ra.org/reg/335/2012}ParameterDefinitionReference"/>
...
@XmlRootElement(name = "VaryingValue")
public class VaryingValue {

    @XmlElement(name = "Interpolation", namespace = "http://www.smpte-ra.org/reg/335/2012", required = true)
    @XmlSchemaType(name = "anySimpleType")
    protected String interpolation;
    @XmlElement(name = "PointList", namespace = "http://www.smpte-ra.org/reg/335/2012", required = true)
    protected ControlPointStrongReferenceVector pointList;
    @XmlElement(name = "ParameterDefinitionReference", namespace = "http://www.smpte-ra.org/reg/335/2012", required = true)
    @XmlSchemaType(name = "anyURI")
    protected String parameterDefinitionReference;
     ...
     * @return
     *     possible object is
     *     {@link ControlPointStrongReferenceVector }
     *     
     */
    public ControlPointStrongReferenceVector getPointList() {
        return pointList;
    }
     ...
     *     
     */
    public void setPointList(ControlPointStrongReferenceVector value) {
        this.pointList = value;
    }

    /**
     * Gets the value of the parameterDefinitionReference property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getParameterDefinitionReference() {
        return parameterDefinitionReference;
    }

    /**
     * Sets the value of the parameterDefinitionReference property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setParameterDefinitionReference(String value) {
        this.parameterDefinitionReference = value;
    }
