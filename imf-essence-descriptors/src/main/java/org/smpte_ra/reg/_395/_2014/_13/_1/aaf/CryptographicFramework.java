 ...
 *       &lt;all>
 *         &lt;element ref="{http://www.smpte-ra.org/reg/335/2012}CryptographicContextObject"/>
...
@XmlRootElement(name = "CryptographicFramework")
public class CryptographicFramework {

    @XmlElement(name = "CryptographicContextObject", namespace = "http://www.smpte-ra.org/reg/335/2012", required = true)
    protected DescriptiveObjectStrongReference cryptographicContextObject;
    ...
    /**
     * Gets the value of the cryptographicContextObject property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public DescriptiveObjectStrongReference getCryptographicContextObject() {
        return cryptographicContextObject;
    }

    /**
     * Sets the value of the cryptographicContextObject property.
     * 
     * @param value
     *     allowed object is
     *     {@link DescriptiveObjectStrongReference }
     *     
     */
    public void setCryptographicContextObject(DescriptiveObjectStrongReference value) {
        this.cryptographicContextObject = value;
    }
