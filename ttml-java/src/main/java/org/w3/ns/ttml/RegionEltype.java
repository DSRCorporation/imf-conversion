...
public class RegionEltype {
    ...
    @XmlElement(name = "set")
    protected List<SetEltype> animationClass;
    @XmlElement(name = "style")
    protected List<StyleEltype> styleRegion;
     ...
     * 
     */
    public List<SetEltype> getAnimationClass() {
        if (animationClass == null) {
            animationClass = new ArrayList<SetEltype>();
        }
        return this.animationClass;
    }

    /**
     * Gets the value of the styleRegion property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the styleRegion property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStyleRegion().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<StyleEltype> getStyleRegion() {
        if (styleRegion == null) {
            styleRegion = new ArrayList<StyleEltype>();
        }
        return this.styleRegion;
    }
