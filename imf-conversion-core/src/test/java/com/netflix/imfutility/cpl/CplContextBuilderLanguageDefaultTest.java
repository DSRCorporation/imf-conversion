...
/**
 * Tests that default language set to sequence context.
 */
@RunWith(Parameterized.class)
public class CplContextBuilderLanguageDefaultTest {
    ...
    @Test
    public void testSequenceLanguageIsDefault() throws Exception {
        assertEquals("fr-FR", sequenceContext.getParameterValue(SequenceContextParameters.LANGUAGE, contextInfo));
    }
    ...
    public static void setUpAll() throws Exception {
        ...
        new CplContextBuilder(contextProvider, assetMap, ImpUtils.getCplLanguages()).build();
